...
export function Toast({ message, tone = 'success' }: ToastProps) {
  ...
  return (
    <View accessibilityLiveRegion="polite" style={styles.base}>
      <Icon color={colors.textPrimary} size={18} strokeWidth={3} />
...
const styles = StyleSheet.create({
  base: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, padding: spacing.md, backgroundColor: colors.success, borderRadius: radius.md },

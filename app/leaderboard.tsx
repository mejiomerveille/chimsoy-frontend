        ...
        {[1, 0, 2].map((idx) => {
          ...
          return (
            <Animated.View key={entry.rank} entering={FadeInDown.delay(idx * 100).duration(400)} style={[styles.podiumSide, idx === 0 && styles.podiumTop]}>
              {idx === 0 && <Crown color={colors.gold} size={24} />}
...
const styles = StyleSheet.create({
  ...
  tab: { paddingHorizontal: spacing.md, paddingVertical: 8, borderRadius: 999, backgroundColor: colors.surface },
  tabActive: { backgroundColor: colors.accent },
  tabText: { color: colors.textSecondary, fontSize: 13, fontWeight: '700', fontFamily: typography.fontFamily.bold },
  ...
  podiumName: { color: colors.textPrimary, fontSize: 13, fontWeight: '700', fontFamily: typography.fontFamily.bold },
  podiumNameTop: { fontSize: 15, fontWeight: '700', fontFamily: typography.fontFamily.bold },
  podiumPoints: { color: colors.textSecondary, fontSize: 11, fontWeight: '600', fontFamily: typography.fontFamily.semiBold },
  podiumBar: { marginTop: 6, paddingHorizontal: spacing.md, paddingVertical: 10, borderRadius: radius.sm, backgroundColor: colors.surface, minWidth: 60, alignItems: 'center' },
  podiumBarTop: { backgroundColor: colors.accent },
  podiumRank: { color: colors.textPrimary, fontSize: 14, fontWeight: '700', fontFamily: typography.fontFamily.bold },
  list: { padding: spacing.lg, gap: spacing.sm },
  row: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, backgroundColor: colors.surface, borderRadius: radius.md, padding: spacing.md },
  rowMe: { backgroundColor: 'rgba(255,106,44,0.12)' },
  rank: { color: colors.textSecondary, fontSize: 14, fontWeight: '700', fontFamily: typography.fontFamily.bold, width: 36 },
  rowInfo: { flex: 1 },
  rowName: { color: colors.textPrimary, fontSize: 14, fontWeight: '700', fontFamily: typography.fontFamily.bold },
  rowCity: { color: colors.textSecondary, fontSize: 12, marginTop: 2, fontFamily: typography.fontFamily.regular },
  rowPoints: { color: colors.accent, fontSize: 16, fontWeight: '700', fontFamily: typography.fontFamily.bold },
});

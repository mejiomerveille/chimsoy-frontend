...
import { colors, spacing, typography , theme} from '@/src/theme/tokens';
...
export default function ResultScreen() {
  ...
  return (
    <LinearGradient
      colors={isWin ? [theme.success, theme.background] : [theme.danger, theme.background]}
      style={styles.container}
    >
      <SafeAreaView style={styles.safe}>
        <View style={styles.center}>
          <Animated.View entering={SlideInDown.springify().damping(12)} style={styles.trophyRing}>
            <Trophy color={isWin ? theme.success : theme.action} size={48} />
          </Animated.View>
          ...
          <Animated.View entering={FadeInDown.delay(800)} style={styles.actions}>
            <Button label="Rejouer" icon={<RotateCcw color={theme.background} size={18} />} onPress={handleReplay} />
            <Button label="Accueil" variant="ghost" icon={<Home color={theme.textSecondary} size={18} />} onPress={handleHome} />
          </Animated.View>
        </View>
      </SafeAreaView>
    </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  resultLabel: { color: theme.textPrimary, fontSize: 36, fontWeight: '700', fontFamily: typography.fontFamily.bold, letterSpacing: -1 },
  ...
  scoreValue: { color: theme.textPrimary, fontSize: 32, fontWeight: '700', fontFamily: typography.fontFamily.bold },
  ...
  rewardValue: { color: theme.reward, fontSize: 28, fontWeight: '700', fontFamily: typography.fontFamily.bold },
  ...
  fallback: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: spacing.md, backgroundColor: theme.background },
  fallbackText: { color: theme.textPrimary, fontSize: 16, fontWeight: '600', fontFamily: typography.fontFamily.semiBold },
});
